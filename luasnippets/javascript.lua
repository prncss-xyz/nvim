...
table.insert(M, s(".map", fmt(".map(([]) => [])", { i(1, "x"), f(to_same, { 1 }) }, { delimiters = "[]" })))
table.insert(M, s("filter", fmt(".filter(([]) => [])", { i(1, "x"), f(to_same, { 1 }) }, { delimiters = "[]" })))

table.insert(M, s("const", fmt("const [] = []", { i(1, "name"), i(2, "0") }, { delimiters = "[]" })))

table.insert(M, s("let", fmt("let [] = []", { i(1, "name"), i(2, "0") }, { delimiters = "[]" })))
...
table.insert(M, s("export default", fmt("export default ", {}, { delimiters = "[]" })))

table.insert(
	M,
	s("dot filter", fmt(".filter(([]) => [])", { i(1, "identifier"), i(2, "true") }, { delimiters = "[]" }))
)

table.insert(M, s("dot map", fmt(".map(([]) => [][])", { i(1, "identifier"), same(1), i(0) }, { delimiters = "[]" })))

table.insert(M, s("lambda", fmt("([]) => []", { i(1, "_params"), i(2, "0") }, { delimiters = "[]" })))

table.insert(M, s("lambda async", fmt("async ([]) => []", { i(1, "_params"), i(2, "0") }, { delimiters = "[]" })))
...
for _, name in ipairs({ "toEqual", "toBe", "toContain", "toMatch", "toBeTruthy", "toBeFalsy" }) do
	table.insert(
		...
		s(
			"expect" .. name,
			fmt("expect([]).[]([])", { i(1, "actual"), t(name), i(2, "expected") }, { delimiters = "[]" })
		)
	)
end
